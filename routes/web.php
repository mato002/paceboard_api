...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/admin/reports', [WebAdminController::class, 'reports']);
    Route::post('/admin/reports', [WebAdminController::class, 'createReport']);
    Route::patch('/admin/reports/{report}/activate', [WebAdminController::class, 'activateReport']);
    Route::patch('/admin/reports/{report}/deactivate', [WebAdminController::class, 'deactivateReport']);
    Route::delete('/admin/reports/{report}', [WebAdminController::class, 'deleteReport']);
    ...
    Route::get('/admin/leaderboards', [WebAdminController::class, 'leaderboards']);
    ...
    Route::get('/admin/routes', [WebAdminController::class, 'routes']);
    Route::patch('/admin/routes/{drivingRoute}/popular', [WebAdminController::class, 'toggleRoutePopular']);
    Route::get('/admin/vehicles', [WebAdminController::class, 'vehicles']);
    Route::get('/admin/activity', [WebAdminController::class, 'activityLogs']);
});
